...
<p align="center">
  <a href="https://github.com/harry0703/MoneyPrinterTurbo/pull/1351"><img alt="harry0703/MoneyPrinterTurbo Merged PR" src="https://img.shields.io/static/v1?label=Merged&message=harry0703%2FMoneyPrinterTurbo+%E2%AD%90+124.9k&color=2ea44f&style=for-the-badge&logo=github" /></a>
  ...
  <a href="https://github.com/volcengine/OpenViking/pull/4213"><img alt="volcengine/OpenViking Merged PR" src="https://img.shields.io/static/v1?label=Merged&message=volcengine%2FOpenViking+%E2%AD%90+38.2k&color=2ea44f&style=for-the-badge&logo=github" /></a>
</p>

| Status | Project | PR | Scope |
| --- | --- | --- | --- |
| Merged | `harry0703/MoneyPrinterTurbo` (124.9k stars) | [#1351](https://github.com/harry0703/MoneyPrinterTurbo/pull/1351) (+35) | Log concat progress while ffmpeg is running |
...
| Merged | `zhayujie/CowAgent` (47.1k stars) | [#3133](https://github.com/zhayujie/CowAgent/pull/3133) (+25) | Ignore empty b64_json/url when saving generated images |
| Merged | `volcengine/OpenViking` (38.2k stars) | [#4213](https://github.com/volcengine/OpenViking/pull/4213) | Render fields without init_value as empty on init |
...
| Merged | `TencentCloud/Octop` (4.4k stars) | [#348](https://github.com/TencentCloud/Octop/pull/348) | Force utf-8 stdio so octop init does not crash on GBK consoles |
...
<p align="center">
<sub>88 merged · 21 in review · 9 closed — 29 repositories, 118 PRs · updated 2026-09-21</sub>
</p>
