...
<p align="center">
  <a href="https://github.com/harry0703/MoneyPrinterTurbo/pull/1351"><img alt="harry0703/MoneyPrinterTurbo Merged PR" src="https://img.shields.io/static/v1?label=Merged&message=harry0703%2FMoneyPrinterTurbo+%E2%AD%90+124.2k&color=2ea44f&style=for-the-badge&logo=github" /></a>
  ...
  <a href="https://github.com/volcengine/OpenViking/pull/4213"><img alt="volcengine/OpenViking Merged PR" src="https://img.shields.io/static/v1?label=Merged&message=volcengine%2FOpenViking+%E2%AD%90+37.7k&color=2ea44f&style=for-the-badge&logo=github" /></a>
</p>

| Status | Project | PR | Scope |
| --- | --- | --- | --- |
| Merged | `harry0703/MoneyPrinterTurbo` (124.2k stars) | [#1351](https://github.com/harry0703/MoneyPrinterTurbo/pull/1351) (+33) | Log concat progress while ffmpeg is running |
| Merged | `CherryHQ/cherry-studio` (51.9k stars) | [#20418](https://github.com/CherryHQ/cherry-studio/pull/20418) (+6) | Fix dead heading anchors in the reference docs |
...
| Merged | `volcengine/OpenViking` (37.7k stars) | [#4213](https://github.com/volcengine/OpenViking/pull/4213) | Render fields without init_value as empty on init |
...
| Merged | `rlaope/oh-my-hermes` (2.5k stars) | [#1044](https://github.com/rlaope/oh-my-hermes/pull/1044) | Refresh stale lintlang snapshot entry |
| Merged | `TencentCloud/Octop` (2.9k stars) | [#348](https://github.com/TencentCloud/Octop/pull/348) | Force utf-8 stdio so octop init does not crash on GBK consoles |
...
<p align="center">
<sub>69 merged · 18 in review · 8 closed — 29 repositories, 95 PRs · updated 2026-09-16</sub>
</p>
